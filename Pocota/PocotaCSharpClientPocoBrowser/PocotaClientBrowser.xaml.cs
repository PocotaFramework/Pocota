...
public partial class PocotaClientBrowser : Window, INotifyPropertyChanged, IUniversalConverter
{
    ...
    private readonly ILogger<PocotaClientBrowser>? _logger;
    ...
    internal PocotaClientBrowser(IServiceProvider services)
    {
        ...
        _logger = Services.GetService<ILoggerFactory>()?.CreateLogger<PocotaClientBrowser>();
    ...
    private void Button_Click_1(object sender, RoutedEventArgs e)
    {
        ...
        {
            Cursor = Cursors.Wait;
            Convert(counts, typeof(IEnumerable), string.Empty, CultureInfo.CurrentUICulture);
    ...
    public object? Convert(object? value, Type targetType, object? parameter, CultureInfo? culture)
    {
        ...
        if (
            ...
            && parameters.Length > 1 
            && "LastActiveWindow".Equals(parameters[0])
            && value == LastActiveWindow
            && parameters[1] is string colorCode
        )
        {
        ...
        if (value is PocosCounts pocosCounts && typeof(IEnumerable).IsAssignableFrom(targetType))
        {
